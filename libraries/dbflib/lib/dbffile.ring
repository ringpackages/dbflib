...
class DBFFile
    ...
    func getCodePageName
        ...
        on C_CODEPAGE_DOS_860      return "DOS Portuguese (CP 860)"
        ...
        on C_CODEPAGE_DOS_862      return "DOS Hebrew (CP 862)"
        on C_CODEPAGE_DOS_864      return "DOS Arabic (CP 864)"
        on C_CODEPAGE_DOS_775      return "DOS Baltic (CP 775)"
        on C_CODEPAGE_DOS_874      return "DOS Thai (CP 874)"
        ...
        on C_CODEPAGE_WIN_874      return "Windows Thai (CP 874)"
        on C_CODEPAGE_WIN_1252_ALT return "Windows ANSI (CP 1252)"
        other                      return "Unknown (" + nCodePage + ")"
        off
