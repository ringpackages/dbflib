aPackageInfo = [
	:name = "The dbflib Package",
	:description = "Our dbflib package using the Ring programming language",
	:folder = "dbflib",
	...
	:ringfolderfiles = 	[
		"bin/load/dbflib.ring",
		"libraries/dbflib/dbflib.ring",
		"libraries/dbflib/lib/constants.rh",
